                    ...
                    <div class="card bg-primary text-dark" style="border-radius: 1rem;">
                        ...
                        <div class="card-body px-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-2">
                                <h2 class="fw-bold mb-2 text-uppercase mb-4 text-danger">Delete Categories</h2>
                                <form method="POST" action={{ "kategori/destroy/".session('delete')->id }}>
                                    @csrf
                                    @method('DELETE')
                                    <div class="form-outline form-white mb-4">
                                        <h3>Are you sure want to delete {{ session('delete')->nama }} ?</h3>
                                    </div>
                                    <div>
